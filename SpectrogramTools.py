...
# On OSX Ventura libsndfile is not detected sometimes. It has to renamed to libsndfile.dylib from libsndfile_arm64.dylib
# It can be done using the following command:
# cp /Library/Frameworks/Python.framework/Versions/3.11/lib/python3.11/site-packages/_soundfile_data/libsndfile_arm64.dylib 
#  /Library/Frameworks/Python.framework/Versions/3.11/lib/python3.11/site-packages/_soundfile_data/libsndfile.dylib
